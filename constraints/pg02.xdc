...
## Declare relevant asynchronous inputs as false paths
set_false_path -from [get_ports {btn[*]}]

## Declare all outputs as false paths
set_false_path -to [all_outputs]

## 12 MHz Clock Signal
set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports { clk_raw_in }]; #IO_L12P_T1_MRCC_14 Sch=gclk
create_clock -add -name sys_clk_pin -period 83.33 -waveform {0 41.66} [get_ports {clk_raw_in}];
...
## Pmod Header JA
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { ja0 }]; #IO_L5N_T0_D07_14 Sch=ja[1]
set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS33 } [get_ports { ja1 }]; #IO_L4N_T0_D05_14 Sch=ja[2]
